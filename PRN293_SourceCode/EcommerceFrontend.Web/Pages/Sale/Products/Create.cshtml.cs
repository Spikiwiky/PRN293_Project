...
namespace EcommerceFrontend.Web.Pages.Sale.Products
{
    ...
    {
        private readonly ISaleProductService _productService;
        private readonly ILogger<CreateModel> _logger;

        [BindProperty]
        public SaleProductCreateDto Product { get; set; } = new();

        public List<SelectListItem> Categories { get; set; } = new();

        public CreateModel(ISaleProductService productService, ILogger<CreateModel> logger)
        {
